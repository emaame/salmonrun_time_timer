...
var _salmonrun_time_timer = __webpack_require__(121);
    ...
    _createClass(View, [{
        ...
        value: function update() {
...

            {
                ...
                var text = eta.getMinutes() + ":" + eta.getSeconds() + "." + eta.getMilliseconds();
            ...
            for (i = 0; i < list.length; ++i) {
                ...
                var date = list[i];
                var text = date.getMinutes() + ":" + date.getSeconds() + "." + date.getMilliseconds();
                element.innerHTML = text;
            }
        }
    }]);
